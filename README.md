...
Actualmente estoy realizando la transcripción de A (Biblioteca Nacional de España, ms. 3369), entre enero y abril de 2023, y B (Biblioteca Histórica de la Universidad de Salamanca, ms. 1958), entre abril y julio del mismo año. La transcripción de F (Biblioteca Histórica de la Universidad de Salamanca, ms. 2401), la traducción latina, corre paralela pero muy lentamente.
...
Cossío Olavide, Mario (2022). «Lucidario, testimonio A (Biblioteca Nacional de España, ms. 3369), transcripción semipaleográfica». <em>Lucidarios, v. 0.2</em>, https://doi.org/10.5281/zenodo.7548608, fecha de consulta.
